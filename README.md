...
* The 3D genomics data is employed as follows: each gene is mapped to a loci using the appropriate assembly, and a signal value is extracted for each gene-gene pair from the Hi-C matrix (maximum value of O/E, using KR normalization). Pairs that exceed a specified threshold (1.0) form edges of the new network.
...
| Aug    |              0.895 |               0.845 |             0.48  |                    0.316 |                0.462 |
| Aug3D |              0.985 |               0.851 |             0.485 |                    0.32  |                0.473 |
